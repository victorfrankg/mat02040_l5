...
pkgs <- c("tidyverse", "leaflet", "sf", "dplyr", "kableExtra", "scales", "smacpod", "rvest", "plotly", "ggpubr","stringr","readr", "devtools", "ggplot2", "sp", "gstat", "lattice", "geoR")
...
variograma <- variogram(Altitude ~ 1, locations =  ~Latitude + Longitude, data = df_final)
...
Podemos perceber que o variograma com modelo Matern estimou um efeito pepita igual à zero. O sill (altura no eixo $y$) atinge o valor de 25768,3, enquanto o range, que representa a distância entre as observações que são mais fortemente correlacionadas espacialmente, é de -2,2.
